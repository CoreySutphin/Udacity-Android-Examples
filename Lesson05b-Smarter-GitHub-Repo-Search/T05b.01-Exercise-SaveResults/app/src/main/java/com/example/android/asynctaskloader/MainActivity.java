...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULTS_RAW_JSON = "reults";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            String rawJsonResults = savedInstanceState.getString(SEARCH_RESULTS_RAW_JSON);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_RESULTS_RAW_JSON, rawJsonResults);
    }
}