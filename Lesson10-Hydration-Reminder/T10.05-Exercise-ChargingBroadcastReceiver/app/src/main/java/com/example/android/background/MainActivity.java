...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargingBroaddcastReceiver mChargingReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingReceiver = new ChargingBroaddcastReceiver();
    ...
    private class ChargingBroaddcastReceiver extends BroadcastReceiver {
